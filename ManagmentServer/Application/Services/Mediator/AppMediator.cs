...
#nullable disable
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (notification is INotifiBase I_base_notify)
            {
        ...
        private void SetTrace_ParrentId(INotifiBase I_base_notify)
        {
        ...
        private void SetTrace_ActivityId(INotifiBase I_base_notify)
        {
