...
export type UserListDataFragment$data = {
  readonly users: {
  ...
  readonly " $fragmentType": "UserListDataFragment";
};
export type UserListDataFragment$key = {
  ...
  "selections": [
    {
      "alias": "users",
      "args": null,
      "concreteType": "GQL_UserConnection",
      "kind": "LinkedField",
      "name": "__UserListConnection_users_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
...
(node as any).hash = "8144aaaf02422ec98d3acd07bc4c83f8";
