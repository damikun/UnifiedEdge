...
export type AdapterListRefetchQuery$variables = {
  after?: string | null;
  first?: number | null;
};
export type AdapterListRefetchQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"AdapterListDataFragment">;
};
export type AdapterListRefetchQuery = {
  response: AdapterListRefetchQuery$data;
  variables: AdapterListRefetchQuery$variables;
};
...
(node as any).hash = "37a2d1ed62f134a7a1bcf77678d4910b";
