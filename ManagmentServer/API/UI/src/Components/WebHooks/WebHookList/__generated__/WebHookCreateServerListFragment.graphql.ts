...
export type WebHookCreateServerListFragment$data = {
  readonly servers: {
  ...
  readonly " $fragmentType": "WebHookCreateServerListFragment";
};
export type WebHookCreateServerListFragment$key = {
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__WebHookCreate_ServerList_Connection_servers_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
