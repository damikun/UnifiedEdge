    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MqttAuthLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MqttAuthLogs_MqttServer_ServerId",
                        column: x => x.ServerId,
                        principalTable: "MqttServer",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, false, false, null, null, "eed20810-3109-4624-b625-0b187bad99dc", null, null, null, "Undefined" });
