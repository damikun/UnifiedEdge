...
export type AdapterSelectPaginationDataFragment$data = {
  readonly adapters: {
  ...
  readonly " $fragmentType": "AdapterSelectPaginationDataFragment";
};
export type AdapterSelectPaginationDataFragment$key = {
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__AdapterSelectPagination_adapters_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
