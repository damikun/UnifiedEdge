...
export type WebHookListDataFragment$data = {
  readonly webHooks: {
  ...
  readonly " $fragmentType": "WebHookListDataFragment";
};
export type WebHookListDataFragment$key = {
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__WebHookListConnection_webHooks_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
