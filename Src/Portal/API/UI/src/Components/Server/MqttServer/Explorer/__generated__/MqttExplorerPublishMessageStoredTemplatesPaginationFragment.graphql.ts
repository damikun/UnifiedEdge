...
export type MqttExplorerPublishMessageStoredTemplatesPaginationFragment$data = {
  readonly __id: string;
  readonly mqttExplorerStoredTemplates: {
    readonly __id: string;
  ...
  readonly " $fragmentType": "MqttExplorerPublishMessageStoredTemplatesPaginationFragment";
};
export type MqttExplorerPublishMessageStoredTemplatesPaginationFragment$key = {
...
return {
  ...
  "selections": [
    {
      "alias": "mqttExplorerStoredTemplates",
      "args": [
        {
          "kind": "Variable",
          "name": "server_uid",
      ...
      "kind": "LinkedField",
      "name": "__MqttExplorerPublishMessageStoredTemplatesPaginationFragmentConnection_mqttExplorerStoredTemplates_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
