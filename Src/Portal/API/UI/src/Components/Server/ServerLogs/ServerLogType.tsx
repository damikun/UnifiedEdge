...
import { ServerEventTypes } from "./__generated__/ServerLogTypeDataFragment.graphql";
import { faExclamationCircle, faExclamationTriangle, faInfo } from "@fortawesome/free-solid-svg-icons";

export const ServerLogTypeData = graphql`
  fragment ServerLogTypeDataFragment on GQL_IServerEvent
  {
    type
  }
`;

type ServerLogTypeProps = {
    state: ServerEventTypes | undefined
  }
  ...
  export function ServerLogTypeBadget({state}:ServerLogTypeProps){
