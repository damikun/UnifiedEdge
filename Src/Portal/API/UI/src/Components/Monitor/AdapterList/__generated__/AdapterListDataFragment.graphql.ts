...
export type AdapterListDataFragment$data = {
  readonly adapters: {
  ...
  readonly " $fragmentType": "AdapterListDataFragment";
};
export type AdapterListDataFragment$key = {
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__AdapterListConnection_adapters_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
